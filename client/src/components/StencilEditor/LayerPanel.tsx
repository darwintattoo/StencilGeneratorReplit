...
export default function LayerPanel({
  ...
  return (
    <div className="fixed inset-0 sm:absolute sm:right-0 sm:top-0 sm:bottom-0 sm:h-auto w-full sm:w-80 sm:border-l border-gray-600 p-3 sm:p-4 overflow-y-auto z-50 bg-black/90 sm:bg-transparent" style={{ backgroundColor: 'rgba(26, 26, 26, 0.98)' }}>
