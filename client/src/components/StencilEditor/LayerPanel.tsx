...
export default function LayerPanel({
  ...
  return (
    <div className="fixed inset-0 sm:absolute sm:left-0 sm:top-0 sm:h-full w-full sm:max-w-80 sm:border-r border-gray-600 p-3 sm:p-4 overflow-y-auto z-50 bg-black/90 sm:bg-transparent" style={{ backgroundColor: 'rgba(26, 26, 26, 0.98)' }}>
